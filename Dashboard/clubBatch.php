          ...
          <div class="content-panel">
            ...
            <?php while($row = mysqli_fetch_assoc($r)) {?>
                  ...
                  ?>
                    ...
                    <td><?php echo $row['batch_des']; ?></td>   
                    <td><?php echo $row['start_date']; ?></td>   
                    <td><?php echo $row['end_date']; ?></td>   
                    <td><?php echo $row['member_limit']; ?></td>  
                    ...
                    <td>
                      ...
                      <button class="btn btn-danger btn-xs"><a href="clubBatchForm.php?batchcode =<?php echo $row['batch_code']?>&stat=Delete"><i class="fa fa-trash-o "></i></a></button>
                    </td>
