            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="MemberRegisterForm.php" class="signup-image-link">Create an account</a>
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Sign In as Member</h2>
                        <form method="POST" action="MemberLogin.php" class="register-form" id="login-form">
