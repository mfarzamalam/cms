...
--
-- Host: localhost
-- Generation Time: Jun 23, 2020 at 06:49 PM
...
CREATE TABLE `register_member` (
  ...
  `member_cont1` int(11) NOT NULL,
  `member_cont2` int(11) DEFAULT NULL,
  `member_cnic` int(13) NOT NULL,
...
--
ALTER TABLE `register_club`
  MODIFY `club_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `register_member`
--
ALTER TABLE `register_member`
  MODIFY `member_code` int(11) NOT NULL AUTO_INCREMENT;
